 ...
 * @constructor
 */
var TimeCalcQueue = module.exports = function(milliseconds) {
	this.queue = [];
 ...
 * @return {Number|null} The average value of the queue, or null if the queue is
 *      empty.
 */
 ...
 * set time frame.
 * @return {Number|null} The maximum value in the queue, or null if the queue is
 *      empty.
 */
 ...
 * set time frame.
 * @return {Number|null} The minimum value in the queue, or null if the queue is
 *      empty.
 */
